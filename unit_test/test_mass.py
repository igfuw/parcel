...
def data(request):
    ...
    parcel(dt = .1, sd_conc = 1024, outfreq = 40, outfile = outfile, z_max = 600., w = .5,\
           ...
           chem_rho = 1.8e3, mean_r = .04e-6, gstdev = 2., n_tot = 566.e6, out_bin = \
...
def test_water_const(data, eps = 6e-15):
    """
...
#    print " "
#
#    print "rhod_parc_init ", rhod_parc_init
#    print "rhod_art_init  ", rhod_art_init
#    print "rho_parc_init  ", rho_parc_init
#    print "rho_art_init   ", rho_art_init
#    print " "
#
#
