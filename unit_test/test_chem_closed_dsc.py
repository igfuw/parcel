...
def test_dissoc_constants(data, ion, eps =\
     ...
     elif ion == "SO2":  check_ions(m_H,   cm.M_H,   m_HSO3, cm.M_HSO3, m_SO2,  cm.M_SO2_H2O, V, cm.K_SO2,  eps[ion])
     elif ion == "HSO3": check_ions(m_H,   cm.M_H,   m_SO3,  cm.M_SO3,  m_HSO3, cm.M_HSO3,    V, cm.K_HSO3, eps[ion]) 
     elif ion == "CO2":  check_ions(m_H,   cm.M_H,   m_HCO3, cm.M_HCO3, m_CO2,  cm.M_CO2_H2O, V, cm.K_CO2,  eps[ion])
     elif ion == "HCO3": check_ions(m_H,   cm.M_H,   m_CO3,  cm.M_CO3,  m_HCO3, cm.M_HCO3,    V, cm.K_HCO3, eps[ion])
     elif ion == "NH3":  check_ions(m_NH4, cm.M_NH4, m_OH,   cm.M_OH,   m_NH3,  cm.M_NH3_H2O, V, cm.K_NH3,  eps[ion])
     elif ion == "HNO3": check_ions(m_H,   cm.M_H,   m_NO3,  cm.M_NO3,  m_HNO3, cm.M_HNO3,    V, cm.K_HNO3, eps[ion])
     else: assert False
