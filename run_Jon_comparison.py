...
os.system("python parcel.py --outfile "+str(outfile)+" --p_0 "+str(p_0)+" --T_0 "+str(T_0)+" --r_0 "+str(r_0)+" --w "+str(w)+" --dt "+str(dt)+" --sd_conc "+str(sd_conc)+" --z_max "+str(z_max)+" --z_min "+str(z_min)+" --top_stop "+str(top_stop)+" --nt "+str(int(nt))+" --aerosol \'"+str(aerosol)+"\' --out_bin \'"+str(out_bin)+"\' --outfreq "+str(int(outfreq)))
